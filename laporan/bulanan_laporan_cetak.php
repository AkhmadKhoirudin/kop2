<?php
    ...
    function exportToExcel($data, $filename) {
        ...
        foreach ($data['headers'] as $header) {
            $output .= "<td><b>" . htmlspecialchars($header) . "</b></td>";
        }
        $output .= "</tr>";
    ...
    // Cek apakah ada request export Excel
    if (isset($_GET['export_excel']) && $_GET['export_excel'] == 'true') {
        ...
        $excel_data['headers'] = ['No', 'Nama Anggota', 'Jenis Simpanan', 'Jumlah (Rp)', 'Tanggal Simpan'];
        ...
        // Generate filename
        $filename = 'Laporan_Simpanan_Bulan_' . $nama_bulan[$bulan] . '_' . $tahun;
        
        // Export ke Excel
        exportToExcel($excel_data, $filename);
    }
...
<head>
    ...
    <style>
        /* Gaya umum untuk tampilan cetak */
        body {
